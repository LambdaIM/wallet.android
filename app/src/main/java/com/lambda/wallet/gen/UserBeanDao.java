...
public class UserBeanDao extends AbstractDao<UserBean, Long> {
    ...
    public static class Properties {
        ...
        public final static Property PrivateKey = new Property(4, String.class, "privateKey", false, "PRIVATE_KEY");
    ...
    public UserBean readEntity(Cursor cursor, int offset) {
        UserBean entity = new UserBean( //
            ...
            cursor.isNull(offset + 4) ? null : cursor.getString(offset + 4), // privateKey
    ...
    public void readEntity(Cursor cursor, UserBean entity, int offset) {
        ...
        entity.setPrivateKey(cursor.isNull(offset + 4) ? null : cursor.getString(offset + 4));
