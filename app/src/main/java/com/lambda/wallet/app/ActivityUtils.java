...
public class ActivityUtils {
     ...
     * @param nextActivity
     */
    public static void nextSeach(Activity curActivity, Class<?> nextActivity , Bundle bundle) {
        next(curActivity, nextActivity, bundle, -1, -1, R.anim.fade_in, R.anim.fade_out,false);
    }
    /**
     * 跳转到下一个页面
     *
     ...
     * @param nextActivity
     */
    public static void nextSeach(Activity curActivity, Class<?> nextActivity ,boolean isfinsh) {
        next(curActivity, nextActivity, -1, -1, R.anim.fade_in, R.anim.fade_out,isfinsh);
    }
    /**
     * 跳转到下一个页面
     *
