package com.lambda.wallet.modules.mining.storemining.activity;
...
import com.lambda.wallet.modules.mining.storemining.fragment.cancelmining.CancelMiningFragment;
import com.lambda.wallet.modules.mining.storemining.fragment.mymining.MyMiningFragment;
...
// TODO: 2019/12/2 存储质押
public class StoreMiningActivity extends BaseAcitvity<NormalView, NormalPresenter> implements NormalView {
    @BindView(R.id.tabs)
    TabLayout mTabs;
    ...
    protected int getLayoutId() {
        return R.layout.activity_store_mining;
    }
    ...
    protected void initViews(Bundle savedInstanceState) {
        setCenterTitle(getString(R.string.store_mining));
