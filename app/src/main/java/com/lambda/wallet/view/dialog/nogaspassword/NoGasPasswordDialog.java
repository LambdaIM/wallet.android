package com.lambda.wallet.view.dialog.nogaspassword;
...
public class NoGasPasswordDialog extends Dialog implements View.OnClickListener {

    NoGasPasswordCallback callback;
    private ClearEditText mClearEditText;
    private TextView sureBtn;
    private TextView cancleBtn;
    private Context context;

    public NoGasPasswordDialog(Context context, NoGasPasswordCallback callback) {
    ...
    private void setCustomDialog() {
        View mView = LayoutInflater.from(getContext()).inflate(R.layout.dialog_nogas_password, null);
        ...
        switch (v.getId()) {
            ...
            case R.id.dialog_confirm_sure:
                if (mClearEditText.getText().toString().trim().length() != 0) {
                    ...
                    ToastUtils.showShortToast(R.string.toast_no_password);
                }
                break;
        }
    }
